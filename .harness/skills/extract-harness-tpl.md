...
### Step 2 -- 分批蒸馏写入
分 7 组：AGENTS.md+README / agents/ / guides/ / skills/（含 subskills/） / plans/（含 active/、completed/、debt-tracker.md） / context/agents/ / context/users/
...
5. Context 文件保留结构，正文替换占位符；特例：users/03-prd-specs.md也需要蒸馏为模板
