...
**Note:** Tell your human partner that Superpowers works much better with access to subagents. The quality of its work will be significantly higher if run on a platform with subagent support (such as Claude Code or Codex). If subagents are available, use .harness/skills/superpowers-ref/subagent-driven-development.md instead of this skill.
...
- **REQUIRED SUB-SKILL:** Use .harness/skills/superpowers-ref/finishing-a-development-branch.md
