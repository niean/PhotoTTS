...
- 根状态：AppState（ObservableObject）管理 fullScreenKind、selectedTab、全屏大图/相机数据、tabXResetId（tab0/2/3）、跨 Tab 协调标志、sessionRecordToPlay（Siri）、isPlayViewActive（播放互斥）、makeTaskIdToReconnect；竖屏 AppDelegate 锁定
