...
- 根状态：AppState（ObservableObject）管理 fullScreenKind、selectedTab、全屏大图/相机数据、tabXResetId（tab0/2/3）、tab0ReselectTrigger/tab2ReselectTrigger、跨 Tab 协调标志（openCameraOnNextRecordAppear/openPhotoPickerOnNextRecordAppear/sessionIdToLoadIntoMake）、isPlayViewActive（播放互斥）、makeTaskIdToReconnect、recordIdToEditInManageTab、homePageStartupPreloadSnapshot、loadingProgress/loadingMessage 等；竖屏 AppDelegate 锁定
